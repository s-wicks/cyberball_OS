define('__ignore__',[],function(){return {};});;
...
;
define('child_process',[],function(){return {};});;
define('dns',[],function(){return {};});;
...
define('pages/Home/home',["require", "exports", "aurelia-templating-resources", "aurelia-framework", "models/settings-model", "models/cpu-settings-model", "clipboard", "nodemailer", "../Setting-Service"], function (require, exports, aurelia_templating_resources_1, aurelia_framework_1, settings_model_1, cpu_settings_model_1, clipboard_1, nodemailer_1, Setting_Service_1) {
    ...
    var HomeViewModel = (function () {
        ...
        HomeViewModel.prototype.sendEmailWithVariable = function (variableValue) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            mailOptions = {
                                from: 'cyberball77@gmail.com',
                                to: 'cyberball77@gmail.com',
                                subject: 'Test Email',
                                text: "Here's the variable value: ".concat(variableValue)
                            };
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                        ...
                        case 3:
                            error_1 = _a.sent();
                            console.error("Error sending email: ".concat(error_1));
                            return [3, 4];
                        case 4: return [2];
                    }
                });
