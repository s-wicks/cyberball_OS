...
define('scenes/cyberball',["require", "exports", "enums/leave-trigger", "phaser"], function (require, exports, leave_trigger_1, phaser_1) {
    ...
    var CyberballScene = (function (_super) {
        ...
        CyberballScene.prototype.create = function () {
            ...
            this.currentIndexText = this.add.text(10, 40, "".concat(this.currentIndex), textStyle);
            this.scheduleIndexText = this.add.text(10, 70, "".concat(this.scheduleIndex), textStyle);
        };
                ...
                this.activeTimeout = setTimeout(function () {
                    ...
                    _this.activeTimeout = setTimeout(function () {
                        if (_this.settings.useSchedule) {
                            ...
                            _this.currentIndex = _this.scheduleIndex;
                            if (_this.settings.schedule[_this.currentIndex] === 0) {
                                _this.currentIndexText.setText("current player: You");
                            }
                            else {
                                _this.currentIndexText.setText("current player: ".concat(_this.settings.computerPlayers[_this.settings.schedule[_this.currentIndex] - 1].name));
                            }
                            _this.scheduleIndex++;
                            if (_this.settings.schedule[_this.scheduleIndex] === 0) {
                                _this.scheduleIndexText.setText("next player: You");
                            }
                            else {
                                _this.scheduleIndexText.setText("next player: ".concat(_this.settings.computerPlayers[_this.settings.schedule[_this.scheduleIndex] - 1].name));
                            }
                        }
                        else {
