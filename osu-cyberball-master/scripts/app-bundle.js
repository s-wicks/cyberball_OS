...
define("pages/PresetPage/PresetPage", function(){});
;
define('text!pages/PresetPage/PresetPage.css',[],function(){return ".landing-page {\n    font-family: Arial, sans-serif;\n    height: 100vh;\n    margin: 0;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    background-color: #f7f7f7;\n    position: relative; /* Added for positioning */\n}\n\n.landing-page .container {\n    text-align: center;\n    background-color: #ffffff;\n    padding: 50px;\n    border-radius: 10px;\n    box-shadow: 0px 10px 25px rgba(0, 0, 0, 0.1);\n    position: relative; /* Added for positioning */\n}\n\n.landing-page .welcome-image {\n    width: 100%;\n    max-width: 300px;\n    margin-bottom: 20px;\n    position: relative; /* Position the image relative to its parent (.landing-page) */\n    display: block; /* Ensure the image takes its own block-level space */\n    margin: 0 auto; /* Center the image horizontally within .landing-page */\n}\n\n\n.landing-page h1 {\n    margin-bottom: 30px;\n    color: #333;\n}\n\n.landing-page .btn {\n    display: inline-block;\n    padding: 10px 20px;\n    margin: 5px;\n    border: none;\n    border-radius: 5px;\n    background-color: #007BFF;\n    color: #ffffff;\n    cursor: pointer;\n    transition: background-color 0.3s ease;\n    text-decoration: none;\n}\n\n.landing-page .btn:hover {\n    background-color: #0056b3;\n}\n\n";});;
